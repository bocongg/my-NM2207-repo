...
historic_state_data_url <- "https://api.covidactnow.org/v2/states.timeseries.json?apiKey=c74d063fa45344649a79b1bd8eb09a95"
...
Step 5: Mapping the variables to questions
```{r, eval=TRUE,echo=TRUE}
time_series <- data %>%
...
time_series_transmission[seq(1,1300,by=100),] %>% pivot_longer(cols=Alaska:District_of_Columbia,names_to="Countries",values_to="Transmission") %>%
